...
export const LUXURY_PRODUCTS: Product[] = [
  ...
  {
    id: "pe-003",
    name: "The Aurelia Sculpted Waist Belt",
    category: "belts",
    priceINR: 7500,
    discountPriceINR: 5499,
    image: "https://images.unsplash.com/photo-1553062407-98eeb64c6a62?auto=format&fit=crop&w=800&q=80",
    hoverImage: "https://images.unsplash.com/photo-1624222247344-550fb8ecf7c2?auto=format&fit=crop&w=800&q=80",
    description: "An elegant waist-defining belt featuring an organic, hand-sculpted gilded closure. Crafted from natural vegetable-tanned French Vachetta leather, it darkens into a gorgeous, personalized patina over time.",
    details: [
      "100% Vegetable-tanned French Vachetta Leather",
      "Artisan-cast organic buckle plated in 18k molten gold finish",
      "Tailored 3.5 cm width - perfect for cinching coats, blazers, or silk slips",
      "Adjustable structure featuring 5 hand-punched sizing points",
      "Rich wax-burnished edges for continuous resilience"
    ],
    specifications: {
      "Width": "3.5 cm",
      "Material": "Vachetta Leather",
      "Hardware": "18k Molten Gold Plated Alloy",
      "Taxes": "Included",
      "Sizes Available": "S (70cm), M (80cm), L (90cm)"
    },
    rating: 5.0,
    stock: 24,
    colors: ["Cognac Gold", "Ebony Black", "Sable Grey"],
    featured: true,
    bestSeller: false
  },
  {
    id: "pe-004",
    name: "The Reversible Monogram Belt",
    category: "belts",
    priceINR: 6800,
    discountPriceINR: 4999,
    image: "https://images.unsplash.com/photo-1614162692292-7ac56d7f7f1e?auto=format&fit=crop&w=800&q=80",
    hoverImage: "https://images.unsplash.com/photo-1598911543663-37d77962ebd1?auto=format&fit=crop&w=800&q=80",
    description: "Two timeless styles in a single beautiful piece. Featuring a smart double-sided rotating toggle buckle, switch between a finely-pebbled black calfskin and a smooth chocolate tan surface seamlessly.",
    details: [
      "Dual-sided reversible Italian calfskin",
      "360-degree rotating tension buckle with branding engraving",
      "Minimalist 2.8 cm width suitable for tailored trousers",
      "High strength fiber core to prevent stretching",
      "Sleek matte titanium hardware finish"
    ],
    specifications: {
      "Width": "2.8 cm",
      "Material": "Dual-faced European Calfskin",
      "Buckle": "Sleek Matte Titanium Monogram",
      "Taxes": "Included",
      "Versatility": "2-in-1 reversible toggle"
    },
    rating: 4.7,
    stock: 18,
    colors: ["Black / Tan Dual Tone"],
    featured: false,
    bestSeller: true
  },
  {
...
export const INITIAL_MOCK_ORDERS: Order[] = [
  {
    ...
    items: [
      ...
      { productId: "pe-003", name: "The Aurelia Sculpted Waist Belt", quantity: 1, price: 5499, color: "Cognac Gold" }
    ],
    shippingAddress: {
      name: "Radhika Mehra",
...
export const INITIAL_MOCK_CUSTOMERS: Customer[] = [
  { id: "cust-01", name: "Radhika Mehra", email: "radhika.mehra@gmail.com", phone: "+91-9876543210", ordersCount: 1, totalSpent: 18448.2 },
